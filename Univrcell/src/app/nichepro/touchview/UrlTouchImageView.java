...
public class UrlTouchImageView extends RelativeLayout {
	...
	public void setmImageView(TouchImageView mImageView) {
    ...
    public UrlTouchImageView(Context ctx,boolean isFrom)
    {
        super(ctx);
        mContext = ctx;
        isFromProductDetail = isFrom;
        init();
    ...
    protected void init() {
        mImageView = new TouchImageView(mContext,isFromProductDetail);
