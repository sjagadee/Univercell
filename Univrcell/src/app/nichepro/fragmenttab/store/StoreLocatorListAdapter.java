...
public class StoreLocatorListAdapter extends
		ArrayAdapter<StoreLocatorResponseObject> {
	...
	public StoreLocatorListAdapter(Context context, LayoutInflater inflater,
