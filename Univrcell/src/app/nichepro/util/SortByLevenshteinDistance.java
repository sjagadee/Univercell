...
/**
 * The Class SortByLevenshteinDistance.
 * Used by auto complete feature to find the best match in the list of string
 */
public class SortByLevenshteinDistance {
	
	/**
	 * Sort array by string min distance.
	 *
	 * @param qtxt the query text
	 * @param inArr the in array list of suggestion
	 * @return the sorted array list of suggestion
	 */
	...
	public class StringObj implements Comparable<StringObj> {
		 ...
		 */
		public int compareTo(StringObj another) {
